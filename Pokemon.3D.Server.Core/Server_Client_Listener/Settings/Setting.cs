    ...
    public class Setting
    {
        ...
        public bool Load()
        {
            try
            {
                            ...
                            if (StartObjectDepth == 1 && string.Equals(ObjectPropertyName, "Main Application Setting", StringComparison.OrdinalIgnoreCase))
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "ApplicationVersion", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Main Application Setting.ApplicationVersion\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "CheckForUpdate", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Main Application Setting.CheckForUpdate\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "GeneratePublicIP", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Main Application Setting.GeneratePublicIP\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "MainEntryPoint", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Main Application Setting.MainEntryPoint\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            else if (StartObjectDepth == 1 && string.Equals(ObjectPropertyName, "Main Server Property", StringComparison.OrdinalIgnoreCase))
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "IPAddress", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Main Server Property.IPAddress\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "Port", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Main Server Property.Port\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "ServerName", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Main Server Property.ServerName\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "ServerMessage", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Main Server Property.ServerMessage\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "WelcomeMessage", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Main Server Property.WelcomeMessage\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            else if (StartObjectDepth == 2 && string.Equals(ObjectPropertyName, "GameMode", StringComparison.OrdinalIgnoreCase))
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    ...
                                    if (string.Equals(PropertyName, "Kolben", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Main Server Property.GameMode.Kolben\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "1 Year Later 3D", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Main Server Property.GameMode.1 Year Later 3D\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "Darkfire Mode", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Main Server Property.GameMode.Darkfire Mode\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "German", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Main Server Property.GameMode.German\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "Pokemon Gold&Silver - RandomLocke", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Main Server Property.GameMode.Pokemon Gold&Silver - RandomLocke\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "Pokemon Lost Silver", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Main Server Property.GameMode.Pokemon Lost Silver\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "Pokemon Silver's Soul", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Main Server Property.GameMode.Pokemon Silver's Soul\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "Pokemon Universal 3D", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Main Server Property.GameMode.Pokemon Universal 3D\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "Others", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Main Server Property.GameMode.Others\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            else if (StartObjectDepth == 1 && string.Equals(ObjectPropertyName, "GameMode", StringComparison.OrdinalIgnoreCase))
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    ...
                                    if (string.Equals(PropertyName, "MaxPlayers", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Main Server Property.MaxPlayers\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "OfflineMode", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Main Server Property.OfflineMode\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            else if (StartObjectDepth == 2 && string.Equals(ObjectPropertyName, "World", StringComparison.OrdinalIgnoreCase))
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "Season", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.World.Season\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "Weather", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.World.Weather\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "DoDayCycle", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.World.DoDayCycle\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "TimeOffset", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.World.TimeOffset\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            else if (StartObjectDepth == 3 && string.Equals(ObjectPropertyName, "SeasonMonth", StringComparison.OrdinalIgnoreCase))
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "January", StringComparison.OrdinalIgnoreCase) || string.Equals(PropertyName, "February", StringComparison.OrdinalIgnoreCase) || string.Equals(PropertyName, "March", StringComparison.OrdinalIgnoreCase) || string.Equals(PropertyName, "April", StringComparison.OrdinalIgnoreCase) || string.Equals(PropertyName, "May", StringComparison.OrdinalIgnoreCase) || string.Equals(PropertyName, "June", StringComparison.OrdinalIgnoreCase) || string.Equals(PropertyName, "July", StringComparison.OrdinalIgnoreCase) || string.Equals(PropertyName, "August", StringComparison.OrdinalIgnoreCase) || string.Equals(PropertyName, "September", StringComparison.OrdinalIgnoreCase) || string.Equals(PropertyName, "October", StringComparison.OrdinalIgnoreCase) || string.Equals(PropertyName, "November", StringComparison.OrdinalIgnoreCase) || string.Equals(PropertyName, "December", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            SeasonMonth.Add("-2");
                                            Core.Logger.Log("\"Advanced Server Property.World.SeasonMonth\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            else if (StartObjectDepth == 3 && string.Equals(ObjectPropertyName, "WeatherSeason", StringComparison.OrdinalIgnoreCase))
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "Winter", StringComparison.OrdinalIgnoreCase) || string.Equals(PropertyName, "Spring", StringComparison.OrdinalIgnoreCase) || string.Equals(PropertyName, "Summer", StringComparison.OrdinalIgnoreCase) || string.Equals(PropertyName, "Fall", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            WeatherSeason.Add("-2");
                                            Core.Logger.Log("\"Advanced Server Property.World.WeatherSeason\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            else if (StartObjectDepth == 2 && string.Equals(ObjectPropertyName, "WeatherSeason", StringComparison.OrdinalIgnoreCase))
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "DefaultWorldCountry", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.World.DefaultWorldCountry\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            else if (StartObjectDepth == 2 && string.Equals(ObjectPropertyName, "Network Ping System", StringComparison.OrdinalIgnoreCase))
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "NoPingKickTime", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.Network Ping System.NoPingKickTime\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "AFKKickTime", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.Network Ping System.AFKKickTime\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "AutoRestartTime", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.Network Ping System.AutoRestartTime\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            else if (StartObjectDepth == 2 && string.Equals(ObjectPropertyName, "Features", StringComparison.OrdinalIgnoreCase))
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "BlackList", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.Features.BlackList\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "IPBlackList", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.Features.IPBlackList\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "WhiteList", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.Features.WhiteList\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "OperatorList", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.Features.OperatorList\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "MuteList", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.Features.MuteList\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "OnlineSettingList", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.Features.OnlineSettingList\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "SwearInfractionList", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.Features.SwearInfractionList\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            else if (StartObjectDepth == 3 && string.Equals(ObjectPropertyName, "Swear Infraction Feature", StringComparison.OrdinalIgnoreCase))
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "SwearInfractionCap", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.World.Swear Infraction Feature.SwearInfractionCap\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "SwearInfractionReset", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.World.Swear Infraction Feature.SwearInfractionReset\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            else if (StartObjectDepth == 3 && string.Equals(ObjectPropertyName, "Chat Feature", StringComparison.OrdinalIgnoreCase))
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "AllowChatInServer", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.World.Chat Feature.AllowChatInServer\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "AllowChatChannels", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.World.Chat Feature.AllowChatChannels\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "CustomChannels", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.World.Chat Feature.CustomChannels\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "SpamResetDuration", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.World.Chat Feature.SpamResetDuration\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            else if (StartObjectDepth == 3 && string.Equals(ObjectPropertyName, "PvP Feature", StringComparison.OrdinalIgnoreCase))
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "AllowPvP", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.World.PvP Feature.AllowPvP\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "AllowPvPValidation", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.World.PvP Feature.AllowPvPValidation\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            else if (StartObjectDepth == 3 && string.Equals(ObjectPropertyName, "Trade Feature", StringComparison.OrdinalIgnoreCase))
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "AllowTrade", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Advanced Server Property.World.Trade Feature.AllowTrade\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            else if (StartObjectDepth == 1 && string.Equals(ObjectPropertyName, "Server Client Logger", StringComparison.OrdinalIgnoreCase))
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "LoggerInfo", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Server Client Logger.LoggerInfo\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "LoggerWarning", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Server Client Logger.LoggerWarning\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "LoggerDebug", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Server Client Logger.LoggerDebug\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "LoggerChat", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Server Client Logger.LoggerChat\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "LoggerPM", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Server Client Logger.LoggerPM\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "LoggerServer", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Server Client Logger.LoggerServer\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "LoggerTrade", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Server Client Logger.LoggerTrade\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "LoggerPvP", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Server Client Logger.LoggerPvP\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "LoggerCommand", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Server Client Logger.LoggerCommand\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            else if (StartObjectDepth == 1 && string.Equals(ObjectPropertyName, "RCON Server Property", StringComparison.OrdinalIgnoreCase))
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "RCONEnable", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"RCON Server Property.RCONEnable\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "RCONPort", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"RCON Server Property.RCONPort\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "RCONPassword", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"RCON Server Property.RCONPassword\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            if (StartObjectDepth == 1)
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "Name", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"BlackList.Name\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "GameJoltID", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"BlackList.GameJoltID\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "Reason", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"BlackList.Reason\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "StartTime", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"BlackList.StartTime\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "Duration", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"BlackList.Duration\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            if (StartObjectDepth == 1)
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "IPAddress", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"IPBlackList.IPAddress\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "Reason", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"IPBlackList.Reason\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "StartTime", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"IPBlackList.StartTime\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "Duration", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"IPBlackList.Duration\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            if (StartObjectDepth == 1)
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "Name", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"MuteList.Name\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "GameJoltID", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"MuteList.GameJoltID\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "Reason", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"MuteList.Reason\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "StartTime", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"MuteList.StartTime\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "Duration", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"MuteList.Duration\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            if (StartObjectDepth == 1)
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "Name", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"OperatorList.Name\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "GameJoltID", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"OperatorList.GameJoltID\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "Reason", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"OperatorList.Reason\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "OperatorLevel", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"OperatorList.OperatorLevel\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            if (StartObjectDepth == 1)
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "Word", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"SwearInfractionFilterListData.Word\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "CaseSensitive", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"SwearInfractionFilterListData.CaseSensitive\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            if (StartObjectDepth == 1)
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "Name", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"SwearInfractionList.Name\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "GameJoltID", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"SwearInfractionList.GameJoltID\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "Points", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"SwearInfractionList.Points\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "Muted", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"SwearInfractionList.Muted\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "StartTime", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"SwearInfractionList.StartTime\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            if (StartObjectDepth == 1)
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "Name", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"WhiteList.Name\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "GameJoltID", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"WhiteList.GameJoltID\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "Reason", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"WhiteList.Reason\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                            ...
                            if (StartObjectDepth == 1)
                            {
                                if (Reader.TokenType == JsonToken.Boolean || Reader.TokenType == JsonToken.Bytes || Reader.TokenType == JsonToken.Date || Reader.TokenType == JsonToken.Float || Reader.TokenType == JsonToken.Integer || Reader.TokenType == JsonToken.Null || Reader.TokenType == JsonToken.String)
                                {
                                    if (string.Equals(PropertyName, "Name", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Token.Name\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                    else if (string.Equals(PropertyName, "Description", StringComparison.OrdinalIgnoreCase))
                                    {
                                        ...
                                        {
                                            Core.Logger.Log("\"Token.Description\" does not match the require type. Default value will be used.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Warning);
                                        }
                                    }
                                }
                            }
                ...
                Core.Logger.Log("Setting loaded.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Info);
                return true;
            }
            catch (Exception ex)
            {
                ex.CatchError();
                Core.Logger.Log("Setting load failed.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Info);
                return false;
            }
        }
...
{0}
                ...
                Core.Logger.Log("Setting saved.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Info);
            }
            catch (Exception ex)
            {
                ex.CatchError();
                Core.Logger.Log("Setting save failed.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Info);
            }
        }
