...
namespace Pokemon_3D_Server_Core.Server_Client_Listener.Loggers
{
    ...
    public class LoggerCollection : IDisposable
    {
        ...
        public void Start()
        {
            ...
            Log("Logger initialized.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Info);
        }
        ...
        public void Log(string Message, Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes LogType, TcpClient Client = null)
        {
            lock (Lock)
            {
                try
