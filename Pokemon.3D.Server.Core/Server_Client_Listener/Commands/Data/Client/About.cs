    ...
    public class About : ICommand
    {
        ...
        public void Handle(Package p, Player Player = null)
        {
            ...
            if (this.MatchRequiredParam(p, Functions.CommandParamType.Nothing))
            {
                ...
                {
                    Core.Logger.Log("This server is created by jianmingyong.", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Info);
                    Core.Logger.Log($"It is running v{Core.Setting.ApplicationVersion}", Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Info);
                }
            }
            #endregion /About
        }
