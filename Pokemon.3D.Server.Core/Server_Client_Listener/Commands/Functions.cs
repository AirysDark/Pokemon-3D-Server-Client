    ...
    public static class Functions
    {
        ...
        public static bool MatchRequiredPermission(this ICommand Command, Player Player)
        {
            ...
            else
            {
                ...
                Core.Logger.Log(Player.isGameJoltPlayer ?
                        ...
                        Core.Setting.Token("SERVER_NOGAMEJOLT", Player.Name, "is unable to use /" + Command.Name + " due to insufficient permission."), Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Command, Player.Network.Client);
                return false;
            }
        }
        ...
        public static void CommandFeedback(this Player Player, string Message, string Message2)
        {
            ...
            if (Message2 != null)
            {
                ...
                Core.Logger.Log(Player.isGameJoltPlayer ?
                    ...
                    , Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Command, Player.Network.Client);
            }
        }
        ...
        public static void HelpPageGenerator(this ICommand Command, Player Player, params string[] Message)
        {
            ...
            else
            {
                for (int i = 0; i < Message.Length; i++)
                {
                    Core.Logger.Log(Message[i], Pokemon_3D_Server_Core.Server_Client_Listener.Loggers.Logger.LogTypes.Info);
                }
            }
        }
    }
