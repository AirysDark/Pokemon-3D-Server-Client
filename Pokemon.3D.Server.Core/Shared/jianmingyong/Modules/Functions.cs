...
[/CODE]",
                ...
                Core.Logger.Log(ex.Message + Environment.NewLine + "Error Log saved at: " + Core.Setting.ApplicationDirectory + "\\CrashLogs\\Crash_" + ErrorTime.Day.ToString() + "-" + ErrorTime.Month.ToString() + "-" + ErrorTime.Year.ToString() + "_" + ErrorTime.Hour.ToString() + "." + ErrorTime.Minute.ToString() + "." + ErrorTime.Second.ToString() + "." + RandomIndetifier + ".dat", Core.Logger.LogTypes.Warning);
            }
            catch (Exception exc)
            {
                Core.Logger.Log(exc.Message, Core.Logger.LogTypes.Warning);
            }
        }
